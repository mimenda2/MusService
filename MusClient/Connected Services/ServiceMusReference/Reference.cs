...
namespace MusClient.ServiceMusReference {
    ...
    public interface IMusService {
        ...
        MusClient.ServiceMusReference.MusData GetMusData(string gameName, string teamName, string userName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMusService/GetMusData", ReplyAction="http://tempuri.org/IMusService/GetMusDataResponse")]
        System.Threading.Tasks.Task<MusClient.ServiceMusReference.MusData> GetMusDataAsync(string gameName, string teamName, string userName);
        ...
        MusClient.ServiceMusReference.MusData GetAllUserCards(string gameName, string teamName, string userName);
        
        [System.ServiceModel.OperationContractAttribute(Action="http://tempuri.org/IMusService/GetAllUserCards", ReplyAction="http://tempuri.org/IMusService/GetAllUserCardsResponse")]
        System.Threading.Tasks.Task<MusClient.ServiceMusReference.MusData> GetAllUserCardsAsync(string gameName, string teamName, string userName);
    ...
    public partial class MusServiceClient : System.ServiceModel.ClientBase<MusClient.ServiceMusReference.IMusService>, MusClient.ServiceMusReference.IMusService {
        ...
        public MusClient.ServiceMusReference.MusData GetMusData(string gameName, string teamName, string userName) {
            return base.Channel.GetMusData(gameName, teamName, userName);
        }
        
        public System.Threading.Tasks.Task<MusClient.ServiceMusReference.MusData> GetMusDataAsync(string gameName, string teamName, string userName) {
        ...
        public MusClient.ServiceMusReference.MusData GetAllUserCards(string gameName, string teamName, string userName) {
            return base.Channel.GetAllUserCards(gameName, teamName, userName);
        }
        
        public System.Threading.Tasks.Task<MusClient.ServiceMusReference.MusData> GetAllUserCardsAsync(string gameName, string teamName, string userName) {
